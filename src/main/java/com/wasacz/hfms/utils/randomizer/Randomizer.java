...
public class Randomizer {
    ...
    private void createExpenseCategoriesList() {
        ...
        ).plannedAmount(BigDecimal.valueOf(1500))
                .build());
        ...
        ).plannedAmount(BigDecimal.valueOf(150))
                .build());
        ...
        ).plannedAmount(BigDecimal.valueOf(1000))
                .build());
        ...
        ).plannedAmount(BigDecimal.valueOf(250))
                .build());
        ...
        ).plannedAmount(BigDecimal.valueOf(100))
                .build());
        ...
        ).plannedAmount(BigDecimal.valueOf(80))
                .build());
        ...
        expenseCategories.put("Other", Properties.builder().products(
                List.of(Product.builder().name("Other expense").minAmount(BigDecimal.valueOf(1)).maxAmount(BigDecimal.valueOf(25)).build())
        )
                .plannedAmount(BigDecimal.valueOf(50))
                .build());
    }
